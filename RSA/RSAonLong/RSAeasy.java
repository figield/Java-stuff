...
public class RSAeasy {
    private long J; // klucz jawny, publiczny
    private long T; // klucz tajny, prywatny
    private long M; // duza liczba jawna
    private long F;
    ...
    public static void main(String[] args) {
        RSAeasy keyRSA = new RSAeasy();        
        Scanner odczyt = new Scanner(System.in);
        System.out.print("Podaj wiadomosc do zakodowania: ");
        String Msg = odczyt.nextLine();
        long[] CodedMsg = keyRSA.code(Msg);
        String DecodedMsg = keyRSA.decode(CodedMsg);
        System.out.print("Zakodowane liczby: ");
        LIB.print_tab(CodedMsg);
        System.out.print("Odkodowane liczby: ");
        System.out.println(DecodedMsg);
    }
}

//Maksymalna wartosc typu long 9223372036854775807
//Minimalna wartosc typu long -9223372036854775808